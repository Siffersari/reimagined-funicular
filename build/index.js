...
const resolvers = {
  ...
  Mutation: {
    ...
    deleteUser: (parent, {
      ...
      const userIndex = _db__WEBPACK_IMPORTED_MODULE_0__["users"].findIndex(user => user.id === parseInt(id));
